...
function botReply(input: string): string {
  ...
  if (/(book|audit|demo|call|talk|contact|started|sign)/.test(q)) {
    return "Easy — head to our 'Get Started' button (top right) and pop in your details. Amy will map out exactly what to automate first. Zero pressure, zero jargon.";
  }
  ...
  if (/(human|person|real|amy|speak)/.test(q)) {
    return "Amy's the real deal behind all this. The quickest way to reach her is the 'Get Started' form — she replies personally, usually same day.";
  }
